...
public class MessageScreen extends LoginComponent {
    ...
    public void render(Client client) {
        ...
        /* Messages */
        client.boldText.drawCenteredText(0xCB9535, centerX + 5, Configuration.NAME, centerY + 10, true);
        client.regularText.drawCenteredText(0xCB9535, centerX + 5, "Error Message", centerY + 30, true);
